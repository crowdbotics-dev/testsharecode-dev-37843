...
## Project Structure
    ...
    ├── testsharecode_dev_37843  # Django project configurations
...
1. Clone this repo and `cd testsharecode_dev_37843`
...
2. Clone this repo and `cd testsharecode_dev_37843`
